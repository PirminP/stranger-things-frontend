...
const hawkins = process.env.REACT_APP_HAWKINS_URL;
const updsidedown = process.env.REACT_APP_UPSIDEDOWN_URL;
const hawkinsTimeout = process.env.REACT_APP_HAWKINS_TIMEOUT;
const updsidedownTimeout = process.env.REACT_APP_UPSIDEDOWN_TIMEOUT;
